#! python3
"""Aquarium, Denis Balako denisarius2000s@gmail.com
Tags: very big, graphics, bext"""
...
try:
    ...
    print('This program requies the bext module.')
    sys.exit()
...
def getRandomColor():
    return random.choice(('yellow', 'red', 'green', 'blue',
                          'purple', 'cyan', 'white'))
...
def drawAquarium():
    ...
    bext.fg('white')
    bext.goto(0, 0)
    print('Fish Tank, by Denis Balako       Ctrl+C to quit.', end='')
